      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card title="Calculadora">
          ...
          <div className="sep mt-4 border-t border-border pt-3">
            <div className="mb-2 text-[11px] font-semibold uppercase tracking-wide text-text3">Opciones de cobro</div>
            <InfoRow label="Envío gratis — compensar con" value={fARS(compensacionGratis)} color="blue" />
            <InfoRow label={`Envío fijo (margen real ${margenFijoReal.toFixed(0)}%)`} value={fARS(opcionFijo)} color="gold" />
            <InfoRow label={`Envío exacto (+${cfg.margen_exacto}%)`} value={fARS(opcionExacto)} color="green" />
          </div>
        </Card>
