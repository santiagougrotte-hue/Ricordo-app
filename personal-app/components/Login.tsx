  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-4">
      <form onSubmit={submit} className="w-full max-w-sm rounded-xl border border-border bg-surface p-7">
        <h1 className="mb-1 text-xl font-bold tracking-wide text-accent">Mi Panel</h1>
        <p className="mb-6 text-xs text-text3">Calendario y Finanzas — Ingresá para continuar</p>
